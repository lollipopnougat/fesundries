...
export function DOMcreateElement(tag: Function | string, attrs?: { [key: string]: any }, ...children: (HTMLElement | string)[]): HTMLElement {
    attrs = attrs || {};
...
export const DOMcreateFragment = (attrs?: { [key: string]: any }, ...children: (HTMLElement | string)[]): HTMLElement => {
